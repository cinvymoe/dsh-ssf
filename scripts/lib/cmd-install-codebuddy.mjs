// Archived: non-DSH platform, DSH-only distribution — see docs/archive/non-dsh-platforms/cmd-install-codebuddy.mjs (original archived, placeholder retains path for test compatibility)
// Original archived to docs/archive/non-dsh-platforms/scripts/lib/cmd-install-codebuddy.mjs
