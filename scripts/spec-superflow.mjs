...
const COMMANDS = {
  ...
  // Archived non-DSH platform installers — retained as stubs for backward compatibility, see docs/archive/non-dsh-platforms/
...
Commands:
  ...
  # Archived platform installers (see docs/archive/non-dsh-platforms/) — DSH-only distribution uses packages/dsh-ssf
...
Examples:
  ...
  ssf doctor
  # DSH plugin: dsh plugin --profile web add <path>/packages/dsh-ssf
  # Archived installers: see docs/archive/non-dsh-platforms/
`;
